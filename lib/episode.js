...
export const STAGE_RULES = {
  rooms: { wanted: false, buildingEntry: false, cars: false, agents: false, special: false, paramsHud: false, fixedHour: 12, startWhen: 'world' },
  city:  { wanted: true,  buildingEntry: true,  cars: true,  agents: true,  special: true,  paramsHud: true,  fixedHour: null, startWhen: 'world' },
};
