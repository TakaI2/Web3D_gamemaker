...
export function createScenario2D(opts = {}) {
  ...
  const FACE_PX = 144, TYPE_CPS_DEF = 18;
  ...
  function ensureDom() {
    ...
    win.style.cssText = 'position:absolute;left:50%;bottom:42px;transform:translateX(-50%);width:min(1150px,94vw);'
      + 'background:rgba(8,10,24,0.86);border:1px solid rgba(140,150,255,0.5);border-radius:14px;padding:16px 22px;'
    ...
    faceFb.style.cssText = 'position:absolute;inset:0;display:flex;align-items:center;justify-content:center;font:900 68px Meiryo,sans-serif;color:#fff;';
    ...
    const name = document.createElement('div'); name.style.cssText = 'font:700 21px Meiryo,sans-serif;margin-bottom:7px;';
    const text = document.createElement('div'); text.style.cssText = 'font:25px/1.7 Meiryo,sans-serif;color:#eef;min-height:3.4em;white-space:pre-wrap;';
